...
(define (to-roman i [answer ""])
  (cond [(zero? i) answer]
        [(>= i 1000) (to-roman (- i 1000) (string-append "M" answer))]
        [(>= i 900) (to-roman (- i 900) (string-append "CM" answer))]
        [(>= i 500) (to-roman (- i 500) (string-append "D" answer))]
        [(>= i 400) (to-roman (- i 400) (string-append "CD" answer))]
        [(>= i 100) (to-roman (- i 100) (string-append "C" answer))]
